...
public class BeanValidation {
	...
	public static <T> Boolean validate (HttpServletRequest request, String key, BookBean bean, Class<T> groupClass ) {
        ...
        // バリデーションを実行
        Set<ConstraintViolation<BookBean>> ConstraintViolationResult = validator.validate(bean, groupClass);
        ...
        for(ConstraintViolation<BookBean> cv : ConstraintViolationResult){
